...
[Method<Element, string>("createElement", "CreateElement", Param1 = "tagName", Comments = "Creates a new element with the given tag name.")]
[Method<Element, string, JsObject>("createElement", "CreateElement", Param1 = "tagName", Param2 = "options", Comments = "Creates a new element with the given tag name.")]
