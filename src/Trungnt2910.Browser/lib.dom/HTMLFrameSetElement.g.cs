...
[JsObject]
public partial class HTMLFrameSetElement: HTMLElement, IWindowEventHandlers
{
    ...
    public string? Cols
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.StringOrNullFromJs($"{_jsThis}.cols");
    ...
    public string? Rows
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.StringOrNullFromJs($"{_jsThis}.rows");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLFrameSetElement>();
