...
/// </summary>
[JsObject]
public partial class SVGGraphicsElement: SVGElement, ISVGTests, ISVGGraphicsElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedTransformList>.ValueOrNullFromJs($"{_jsThis}.transform");
    }
    ...
    /// To be added.
    /// </summary>
    public DOMRect? GetBBox(SVGBoundingBoxOptions? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<DOMRect>.ValueOrNullFromJs($"{_jsThis}.getBBox({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public DOMMatrix? GetCTM() => global::Trungnt2910.Browser.WebAssemblyRuntime<DOMMatrix>.ValueOrNullFromJs($"{_jsThis}.getCTM()");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public DOMMatrix? GetScreenCTM() => global::Trungnt2910.Browser.WebAssemblyRuntime<DOMMatrix>.ValueOrNullFromJs($"{_jsThis}.getScreenCTM()");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGGraphicsElement>();
