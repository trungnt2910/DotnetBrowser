...
public partial class SVGClipPathElement: SVGElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedEnumeration>.ValueOrNullFromJs($"{_jsThis}.clipPathUnits");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGClipPathElement>();
