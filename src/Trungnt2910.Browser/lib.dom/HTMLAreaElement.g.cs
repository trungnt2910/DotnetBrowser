...
/// </summary>
[JsObject]
public partial class HTMLAreaElement: HTMLElement, IHTMLHyperlinkElementUtils
{
    ...
    public bool? NoHref
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.noHref");
        set => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.noHref = {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(value))}");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLAreaElement>();
