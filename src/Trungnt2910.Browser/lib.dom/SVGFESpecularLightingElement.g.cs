...
/// </summary>
[JsObject]
public partial class SVGFESpecularLightingElement: SVGElement, ISVGFilterPrimitiveStandardAttributes
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.specularConstant");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.specularExponent");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.surfaceScale");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFESpecularLightingElement>();
