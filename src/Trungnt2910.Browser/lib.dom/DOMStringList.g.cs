...
/// </summary>
[JsObject]
public partial class DOMStringList: JsObject, global::System.Collections.Generic.IReadOnlyList<string?>
{
    ...
    /// </summary>
    public bool? Contains(string? @string) => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.contains({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(@string))})");
