...
public partial class SVGMaskElement: SVGElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedEnumeration>.ValueOrNullFromJs($"{_jsThis}.maskContentUnits");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedEnumeration>.ValueOrNullFromJs($"{_jsThis}.maskUnits");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGMaskElement>();
