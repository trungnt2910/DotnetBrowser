...
/// </summary>
[JsObject]
public partial class SVGElement: Element, IDocumentAndElementEventHandlers, IElementCSSInlineStyle, IGlobalEventHandlers, IHTMLOrSVGElement, ISVGElement
{
    ...
    public JsObject? ClassName
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsObject>.ValueOrNullFromJs($"{_jsThis}.className");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGSVGElement>.ValueOrNullFromJs($"{_jsThis}.ownerSVGElement");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGElement>.ValueOrNullFromJs($"{_jsThis}.viewportElement");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGElement>();
