...
public partial class HTMLOptionElement: HTMLElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.defaultSelected");
        set => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.defaultSelected = {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(value))}");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.selected");
        set => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.selected = {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(value))}");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLOptionElement>();
