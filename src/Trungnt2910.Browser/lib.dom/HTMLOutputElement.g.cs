...
public partial class HTMLOutputElement: HTMLElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<DOMTokenList>.ValueOrNullFromJs($"{_jsThis}.htmlFor");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLOutputElement>();
