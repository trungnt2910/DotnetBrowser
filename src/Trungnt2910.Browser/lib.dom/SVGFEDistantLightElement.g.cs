...
public partial class SVGFEDistantLightElement: SVGElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.azimuth");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.elevation");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFEDistantLightElement>();
