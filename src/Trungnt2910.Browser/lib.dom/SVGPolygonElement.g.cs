...
/// </summary>
[JsObject]
public partial class SVGPolygonElement: SVGGeometryElement, ISVGAnimatedPoints
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGPolygonElement>();
