...
/// </summary>
[JsObject]
public partial class HTMLSelectElement: HTMLElement, global::System.Collections.Generic.IReadOnlyList<Union<HTMLOptionElement, HTMLOptGroupElement>?>
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<HTMLOptionsCollection>.ValueOrNullFromJs($"{_jsThis}.options");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<HTMLCollectionOf<HTMLOptionElement>>.ValueOrNullFromJs($"{_jsThis}.selectedOptions");
    }
    ...
    public HTMLOptionElement? Item(double? index) => global::Trungnt2910.Browser.WebAssemblyRuntime<HTMLOptionElement>.ValueOrNullFromJs($"{_jsThis}.item({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(index))})");
    ...
    public HTMLOptionElement? NamedItem(string? name) => global::Trungnt2910.Browser.WebAssemblyRuntime<HTMLOptionElement>.ValueOrNullFromJs($"{_jsThis}.namedItem({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(name))})");
    ...
    public Union<HTMLOptionElement, HTMLOptGroupElement>? this[double name]
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<Union<HTMLOptionElement, HTMLOptGroupElement>>.ValueOrNullFromJs($"{_jsThis}[{(global::Trungnt2910.Browser.JsObject.ToJsObjectString(name))}]");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLSelectElement>();
    ...
    /// <inheritdoc/>
    [global::System.Runtime.CompilerServices.IndexerName("Indexer")]
    public Union<HTMLOptionElement, HTMLOptGroupElement>? this[int name] => global::Trungnt2910.Browser.WebAssemblyRuntime<Union<HTMLOptionElement, HTMLOptGroupElement>>.ValueOrNullFromJs($"{_jsThis}[{(global::Trungnt2910.Browser.JsObject.ToJsObjectString(name))}]");
    
    
    /// <inheritdoc/>
    public global::System.Collections.Generic.IEnumerator<Union<HTMLOptionElement, HTMLOptGroupElement>?> GetEnumerator() { for (int i = 0; i < Count; ++i) yield return this[i]; }
