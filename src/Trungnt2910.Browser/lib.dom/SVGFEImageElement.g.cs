...
/// </summary>
[JsObject]
public partial class SVGFEImageElement: SVGElement, ISVGFilterPrimitiveStandardAttributes, ISVGURIReference
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFEImageElement>();
