...
public interface IDocumentAndElementEventHandlers
{
    ...
    /// To be added.
    /// </summary>
    public JsFunc<DocumentAndElementEventHandlers?, ClipboardEvent?, JsObject?>? OnCopy { get; set; }
    /// <summary>
    /// To be added.
    /// </summary>
    public JsFunc<DocumentAndElementEventHandlers?, ClipboardEvent?, JsObject?>? OnCut { get; set; }
    /// <summary>
    /// To be added.
    /// </summary>
    public JsFunc<DocumentAndElementEventHandlers?, ClipboardEvent?, JsObject?>? OnPaste { get; set; }
    /// <summary>
    /// To be added.
    /// </summary>
