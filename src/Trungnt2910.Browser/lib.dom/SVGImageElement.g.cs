...
/// </summary>
[JsObject]
public partial class SVGImageElement: SVGGraphicsElement, ISVGURIReference
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGImageElement>();
