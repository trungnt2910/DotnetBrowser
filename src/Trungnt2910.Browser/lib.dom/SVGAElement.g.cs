...
/// </summary>
[JsObject]
public partial class SVGAElement: SVGGraphicsElement, ISVGURIReference
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedString>.ValueOrNullFromJs($"{_jsThis}.target");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGAElement>();
