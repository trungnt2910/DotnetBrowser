...
public partial class FileSystemHandle: JsObject
{
    ...
    /// To be added.
    /// </summary>
    public Promise<bool>? IsSameEntry(FileSystemHandle? other) => global::Trungnt2910.Browser.WebAssemblyRuntime<Promise<bool>>.ValueOrNullFromJs($"{_jsThis}.isSameEntry({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(other))})");
