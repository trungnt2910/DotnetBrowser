...
public partial class AudioScheduledSourceNode: AudioNode
{
    ...
    /// To be added.
    /// </summary>
    public JsFunc<AudioScheduledSourceNode?, Event?, JsObject?>? OnEnded
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<AudioScheduledSourceNode?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onended");
    ...
    /// To be added.
    /// </summary>
    public void Start(double? when) => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.start({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(when))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public void Stop(double? when) => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.stop({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(when))})");
