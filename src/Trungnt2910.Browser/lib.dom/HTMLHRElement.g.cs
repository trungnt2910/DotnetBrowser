...
public partial class HTMLHRElement: HTMLElement
{
    ...
    public bool? NoShade
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.noShade");
        set => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.noShade = {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(value))}");
    }
    ...
    public string? Size
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.StringOrNullFromJs($"{_jsThis}.size");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLHRElement>();
