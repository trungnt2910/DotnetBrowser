...
/// </summary>
[JsObject]
public partial class SVGGeometryElement: SVGGraphicsElement, ISVGGeometryElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.pathLength");
    }
    ...
    /// To be added.
    /// </summary>
    public DOMPoint? GetPointAtLength(double? distance) => global::Trungnt2910.Browser.WebAssemblyRuntime<DOMPoint>.ValueOrNullFromJs($"{_jsThis}.getPointAtLength({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(distance))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public double? GetTotalLength() => global::Trungnt2910.Browser.WebAssemblyRuntime.doubleOrNullFromJs($"{_jsThis}.getTotalLength()");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public bool? IsPointInFill(DOMPointInit? point) => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.isPointInFill({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(point))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public bool? IsPointInStroke(DOMPointInit? point) => global::Trungnt2910.Browser.WebAssemblyRuntime.boolOrNullFromJs($"{_jsThis}.isPointInStroke({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(point))})");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGGeometryElement>();
