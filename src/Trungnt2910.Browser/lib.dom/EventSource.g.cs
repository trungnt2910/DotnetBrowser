...
public partial class EventSource: EventTarget
{
    ...
    /// To be added.
    /// </summary>
    public JsFunc<EventSource?, Event?, JsObject?>? OnError
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<EventSource?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onerror");
    ...
    /// To be added.
    /// </summary>
    public JsFunc<EventSource?, MessageEvent?, JsObject?>? OnMessage
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<EventSource?, MessageEvent?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onmessage");
    ...
    /// To be added.
    /// </summary>
    public JsFunc<EventSource?, Event?, JsObject?>? OnOpen
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<EventSource?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onopen");
    ...
    /// To be added.
    /// </summary>
    public void RemoveEventListener(string? type, JsFunc<EventSource?, MessageEvent?, JsObject?>? listener, Union<bool, EventListenerOptions>? options) => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.removeEventListener({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(type))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(listener))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    ...
    private void _DispatcherForMessageOfTypeMessageEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<EventSource>();
