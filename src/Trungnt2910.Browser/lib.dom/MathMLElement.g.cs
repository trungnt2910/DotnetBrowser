...
/// </summary>
[JsObject]
public partial class MathMLElement: Element, IDocumentAndElementEventHandlers, IElementCSSInlineStyle, IGlobalEventHandlers, IHTMLOrSVGElement
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<MathMLElement>();
