...
public partial class HTMLDataListElement: HTMLElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<HTMLCollectionOf<HTMLOptionElement>>.ValueOrNullFromJs($"{_jsThis}.options");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLDataListElement>();
