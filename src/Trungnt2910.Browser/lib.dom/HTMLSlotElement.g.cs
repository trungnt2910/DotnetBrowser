...
public partial class HTMLSlotElement: HTMLElement
{
    ...
    /// To be added.
    /// </summary>
    public void Assign(params Union<IElement, Text>?[]? nodes) => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.assign({(string.Join(",", global::System.Linq.Enumerable.Select(nodes ?? global::System.Array.Empty<Union<IElement, Text>>(), __arg => global::Trungnt2910.Browser.JsObject.ToJsObjectString(__arg))))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public JsArray<Element>? AssignedElements(AssignedNodesOptions? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<JsArray<Element>>.ValueOrNullFromJs($"{_jsThis}.assignedElements({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public JsArray<Node>? AssignedNodes(AssignedNodesOptions? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<JsArray<Node>>.ValueOrNullFromJs($"{_jsThis}.assignedNodes({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLSlotElement>();
