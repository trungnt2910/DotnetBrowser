...
/// </summary>
[JsObject]
public partial class SVGPolylineElement: SVGGeometryElement, ISVGAnimatedPoints
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGPointList>.ValueOrNullFromJs($"{_jsThis}.animatedPoints");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGPointList>.ValueOrNullFromJs($"{_jsThis}.points");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGPolylineElement>();
