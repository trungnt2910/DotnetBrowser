...
/// </summary>
[JsObject]
public partial class GlobalEventHandlers: EventTarget, IGlobalEventHandlers
{
    ...
    private void _DispatcherForWhenAbortedOfTypeUIEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<GlobalEventHandlers>();
