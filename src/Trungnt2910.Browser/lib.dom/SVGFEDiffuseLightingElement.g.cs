...
/// </summary>
[JsObject]
public partial class SVGFEDiffuseLightingElement: SVGElement, ISVGFilterPrimitiveStandardAttributes
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedNumber>.ValueOrNullFromJs($"{_jsThis}.diffuseConstant");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFEDiffuseLightingElement>();
