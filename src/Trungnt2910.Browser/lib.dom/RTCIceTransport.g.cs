...
public partial class RTCIceTransport: EventTarget
{
    ...
    /// To be added.
    /// </summary>
    public string? GatheringState
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime.StringOrNullFromJs($"{_jsThis}.gatheringState");
    }
    ...
    /// To be added.
    /// </summary>
    public JsFunc<RTCIceTransport?, Event?, JsObject?>? OnGatheringStateChange
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<RTCIceTransport?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.ongatheringstatechange");
        set => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.ongatheringstatechange = {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(value))}");
    }
    ...
    /// To be added.
    /// </summary>
    public JsFunc<RTCIceTransport?, Event?, JsObject?>? OnStateChange
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<RTCIceTransport?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onstatechange");
    ...
    /// To be added.
    /// </summary>
    public event EventHandler<Event?> GatheringStateChange
    {
        add => AddEventListener("gatheringstatechange", value);
        remove => RemoveEventListener("gatheringstatechange", value);
    }
