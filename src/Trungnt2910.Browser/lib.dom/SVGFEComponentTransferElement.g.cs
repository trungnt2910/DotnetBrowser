...
/// </summary>
[JsObject]
public partial class SVGFEComponentTransferElement: SVGElement, ISVGFilterPrimitiveStandardAttributes
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFEComponentTransferElement>();
