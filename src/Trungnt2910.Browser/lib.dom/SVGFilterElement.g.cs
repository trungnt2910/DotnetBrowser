...
/// </summary>
[JsObject]
public partial class SVGFilterElement: SVGElement, ISVGURIReference
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedEnumeration>.ValueOrNullFromJs($"{_jsThis}.filterUnits");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedEnumeration>.ValueOrNullFromJs($"{_jsThis}.primitiveUnits");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFilterElement>();
