...
public interface ICanvasImageData
{
    ...
    /// To be added.
    /// </summary>
    public ImageData? CreateImageData(double? sw, double? sh, ImageDataSettings? settings);
    /// <summary>
    /// To be added.
    /// </summary>
    ...
    /// To be added.
    /// </summary>
    public ImageData? GetImageData(double? sx, double? sy, double? sw, double? sh, ImageDataSettings? settings);
    /// <summary>
    /// To be added.
    /// </summary>
