...
public partial class HTMLMapElement: HTMLElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<HTMLCollection>.ValueOrNullFromJs($"{_jsThis}.areas");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLMapElement>();
