...
public partial class HTMLCanvasElement: HTMLElement
{
    ...
    /// To be added.
    /// </summary>
    public MediaStream? CaptureStream(double? frameRequestRate) => global::Trungnt2910.Browser.WebAssemblyRuntime<MediaStream>.ValueOrNullFromJs($"{_jsThis}.captureStream({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(frameRequestRate))})");
    ...
    public CanvasRenderingContext2D? GetContext(string? contextId, CanvasRenderingContext2DSettings? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<CanvasRenderingContext2D>.ValueOrNullFromJs($"{_jsThis}.getContext({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(contextId))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public ImageBitmapRenderingContext? GetContext(string? contextId, ImageBitmapRenderingContextSettings? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<ImageBitmapRenderingContext>.ValueOrNullFromJs($"{_jsThis}.getContext({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(contextId))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public Union<WebGLRenderingContext, WebGL2RenderingContext>? GetContext(string? contextId, WebGLContextAttributes? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<Union<WebGLRenderingContext, WebGL2RenderingContext>>.ValueOrNullFromJs($"{_jsThis}.getContext({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(contextId))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    ...
    /// To be added.
    /// </summary>
    public Union<CanvasRenderingContext2D, ImageBitmapRenderingContext, WebGLRenderingContext, WebGL2RenderingContext>? GetContext(string? contextId, JsObject? options) => global::Trungnt2910.Browser.WebAssemblyRuntime<Union<CanvasRenderingContext2D, ImageBitmapRenderingContext, WebGLRenderingContext, WebGL2RenderingContext>>.ValueOrNullFromJs($"{_jsThis}.getContext({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(contextId))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(options))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public void ToBlob(BlobCallback? callback, string? type, JsObject? quality) => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.toBlob({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(callback))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(type))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(quality))})");
    ...
    public string? ToDataURL(string? type, JsObject? quality) => global::Trungnt2910.Browser.WebAssemblyRuntime.StringOrNullFromJs($"{_jsThis}.toDataURL({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(type))}, {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(quality))})");
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<HTMLCanvasElement>();
