...
public partial class SVGRectElement: SVGGeometryElement
{
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedLength>.ValueOrNullFromJs($"{_jsThis}.rx");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<SVGAnimatedLength>.ValueOrNullFromJs($"{_jsThis}.ry");
    }
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGRectElement>();
