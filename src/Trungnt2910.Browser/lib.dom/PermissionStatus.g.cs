...
public partial class PermissionStatus: EventTarget
{
    ...
    /// To be added.
    /// </summary>
    public JsFunc<PermissionStatus?, Event?, JsObject?>? OnChange
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<PermissionStatus?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onchange");
