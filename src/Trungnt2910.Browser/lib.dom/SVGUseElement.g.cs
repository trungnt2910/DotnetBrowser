...
/// </summary>
[JsObject]
public partial class SVGUseElement: SVGGraphicsElement, ISVGURIReference
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGUseElement>();
