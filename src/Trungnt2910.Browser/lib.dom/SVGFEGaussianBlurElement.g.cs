...
/// </summary>
[JsObject]
public partial class SVGFEGaussianBlurElement: SVGElement, ISVGFilterPrimitiveStandardAttributes
{
    ...
    private void _DispatcherForCopyOfTypeClipboardEvent(object? sender, Event? args)
    {
        ...
        if (sender is EventTarget eventTarget) castedSender = eventTarget.Cast<SVGFEGaussianBlurElement>();
