...
public partial class ScreenOrientation: EventTarget
{
    ...
    /// To be added.
    /// </summary>
    public JsFunc<ScreenOrientation?, Event?, JsObject?>? OnChange
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<ScreenOrientation?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onchange");
    ...
    /// To be added.
    /// </summary>
    public Promise? Lock(string? orientation) => global::Trungnt2910.Browser.WebAssemblyRuntime<Promise>.ValueOrNullFromJs($"{_jsThis}.lock({(global::Trungnt2910.Browser.JsObject.ToJsObjectString(orientation))})");
    
    
    /// <summary>
    /// To be added.
    /// </summary>
    public void Unlock() => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.unlock()");
