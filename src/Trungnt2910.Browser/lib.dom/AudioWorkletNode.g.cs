...
public partial class AudioWorkletNode: AudioNode
{
    ...
    /// To be added.
    /// </summary>
    public JsFunc<AudioWorkletNode?, Event?, JsObject?>? OnProcessorError
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<JsFunc<AudioWorkletNode?, Event?, JsObject?>>.ValueOrNullFromJs($"{_jsThis}.onprocessorerror");
        set => global::Trungnt2910.Browser.WebAssemblyRuntime.InvokeJS($"{_jsThis}.onprocessorerror = {(global::Trungnt2910.Browser.JsObject.ToJsObjectString(value))}");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<AudioParamMap>.ValueOrNullFromJs($"{_jsThis}.parameters");
    }
    ...
    {
        get => global::Trungnt2910.Browser.WebAssemblyRuntime<MessagePort>.ValueOrNullFromJs($"{_jsThis}.port");
    }
    ...
    /// To be added.
    /// </summary>
    public event EventHandler<Event?> ProcessorError
    {
        add => AddEventListener("processorerror", value);
        remove => RemoveEventListener("processorerror", value);
    }
