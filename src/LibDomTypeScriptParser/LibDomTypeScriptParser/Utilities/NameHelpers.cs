namespace LibDomTypeScriptParser.Utilities;

public static class NameHelpers
{
    private static readonly IReadOnlySet<string> _keywords = new HashSet<string> 
        { "namespace", "event", "string", "object", "ref", "lock" };

    private static readonly IReadOnlySet<string> _englishWords = new HashSet<string>
    {
    ...
    private static bool TryBruteForce(string jsName, List<string> list, int startIndex)
    {
        ...
        {
            var word = jsName[startIndex..endIndex];
