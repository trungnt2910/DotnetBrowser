...
public class Event: ICloneable
{
    ...
    public string ToString(Context context, bool generateAsClass = false, string? ownerName = null)
    {
        ...
        else
        {
            ...
            var internalElementsSuffix = $"For{Name.ToCSharpEventName()}OfType{typeString.Replace("<", "_").Replace(">", "_").Replace(",", "_").Replace("?", "_")}";
            if (!string.IsNullOrEmpty(InterfaceName))
            {
                internalElementsSuffix += $"ImplementingInterface{InterfaceName!.Replace("<", "_").Replace(">", "_").Replace(",", "_").Replace("?", "_")}";
            }
